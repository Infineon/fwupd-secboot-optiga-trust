...
- *[[#introduction][Introduction]]*
  - [[#hardware_reqs][Required hardware (boards) and software (libraries)]]
  - [[#development_env][Development environment]]
- *[[#key_management][Key management: preparing the developer’s private DFU key and public-key certificate]]*
...
- *[[#personalization][Trust X personalization: installing the developer certificate onto Trust X]]*
  - [[#][Implement personalization application]]
  - [[#][About metadata]]
  - [[#][Copy developer certificate into personalization application]]
  - [[#][Compile and program the application]]
- *[[#application][Application: preparing a dummy application for testing]]*
  - [[#][Preparing the project and compiling the firmware binary]]
  - [[#][Preparing the update packages (ZIP files)]]
- *[[#bootloader][Bootloader: prepare a Trust X based bootloader]]*
  - [[#][Add Trust X dependencies to Nordic SDK bootloade]]
  - [[#][Testing]]
- *[[#prepare_fw_image][Prepare complete firmware binary]]*
...
- *[[#testing_secure_boot][Testing secure boot]]*
...
- *[[#dfu_without_dsecure_boot][Using Secure DFU without Secure Boot]]*
